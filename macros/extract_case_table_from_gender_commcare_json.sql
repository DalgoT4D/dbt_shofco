...
{% docs extract_case_table_from_gender_commcare_json %}
...
{% macro extract_case_table_from_gender_commcare_json(commcare_case_type, case_type_properties_dict, has_parent=false) %}
    ...
    FROM  {{ source('staging_gender','raw_case') }}
