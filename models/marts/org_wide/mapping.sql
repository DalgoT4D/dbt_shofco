...
SELECT
    ...
    CASE
        WHEN gender_intervention IS NOT NULL AND wash_intervention IS NOT NULL AND education_intervention IS NOT NULL
            THEN 
                gender_intervention || ', ' || wash_intervention || ', ' || education_intervention
        WHEN gender_intervention IS NOT NULL AND wash_intervention IS NOT NULL
            THEN 
                gender_intervention || ', ' || wash_intervention
        WHEN gender_intervention IS NOT NULL AND education_intervention IS NOT NULL
            THEN 
                gender_intervention || ', ' || education_intervention
        WHEN wash_intervention IS NOT NULL AND education_intervention IS NOT NULL
            THEN 
