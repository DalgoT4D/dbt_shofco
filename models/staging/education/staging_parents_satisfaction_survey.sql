...
SELECT
    ...
    -> 'form'
    -> 'section_b'
    ->> 'section_b_parents_and_teachers_relationships' AS teacher_parent_relationship,
    json_data
    -> 'form'
    -> 'section_b'
    ...
    -> 'form'
    -> 'section_g'
    ->> 'section_g_parental_engagement_requested_by_the_school' AS parental_engagement_satisfaction,
    json_data
    -> 'form'
    -> 'section_g'
    ->> 'how_satisfied_are_you_with_the_level_of_parental_engagement_requested_by_th' AS parental_engagement_satisfaction_detail,

    -- Improvement Suggestions
    json_data
    -> 'form'
    -> 'section_i'
    ->> 'section_i_suggestions_for_improvement_at_the_school' AS improvement_suggestions,
    json_data
    -> 'form'
    -> 'section_i'
    ...
    -> 'form'
    -> 'section_h'
    ->> 'since_your_daughter_joined_the_shofco_school_which_changes_have_you_seen_in' AS observed_changes,
    json_data
    -> 'form'
    -> 'section_h'
    ->> 'section_h_changes_you_have_seen_in_your_child' AS changes_in_child,

    -- Other Details
    json_data
    -> 'form'
    ->> 'in_the_past_one_year_has_you_or_any_member_of_your_family_benefitted_from_o' AS family_benefit,
    json_data
    -> 'form'
    ->> 'parents_satisfaction_survey_background_and_purpose_in_order_to_continuously' AS survey_background,
