...
SELECT
    ...
    json_data->'form'->'section_b'->>'section_b_parents_and_teachers_relationships' AS parent_teacher_relationship,
    ...
    json_data->'form'->'section_c'->>'sectionc_commentsrecommendation' AS student_teacher_ratio_comments,
    ...
    json_data->'form'->'section_d'->>'sectiond_commentssuggestions' AS sanitation_comments,
    ...
    json_data->'form'->'section_e'->>'sectione_commentssuggestions' AS feeding_program_comments,
    ...
    json_data->'form'->'section_f'->>'sectionf_commentssuggestions' AS extracurricular_comments,

    -- Section G - Teacher Engagement
    json_data->'form'->'section_g'->>'section_g_teacher_engagement_beyond_normal_class_teaching' AS teacher_engagement,
    json_data->'form'->'section_g'->>'how_satisfied_are_you_with_the_level_of_teacher_engagement_in_non-teaching_' AS teacher_engagement_satisfaction,
    json_data->'form'->'section_g'->>'sectiong_commentssuggestions' AS teacher_engagement_comments,

    -- Section H - Suggestions for Improvement
    json_data->'form'->'section_h'->>'section_h_suggestions_for_improvement_at_the_school' AS improvement_suggestions,
    json_data->'form'->'section_h'->>'if_you_could_propose_some_changes_at_the_school_what_could_those_be' AS proposed_changes,

    -- Additional Details
    json_data->'form'->>'background_and_purpose_in_order_to_continuously_improve_on_our_education_se' AS survey_background
