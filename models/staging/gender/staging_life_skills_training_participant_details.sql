    ...
    SELECT
        ...
        CASE
            WHEN
                ...
                = 'term_1'
                THEN to_timestamp('2024-08-31', 'YYYY-MM-DD')
            WHEN
                (data::jsonb -> 'form' -> 'school_information' ->> 'term')
                = 'term_2'
                THEN to_timestamp('2024-01-01', 'YYYY-MM-DD')
            WHEN
                (data::jsonb -> 'form' -> 'school_information' ->> 'term')
                = 'term3'
                THEN to_timestamp('2024-04-21', 'YYYY-MM-DD')
            ELSE NULL::timestamp
        ...
        CASE
            WHEN
                (data::jsonb -> 'form' -> 'school_information' ->> 'term')
                = 'term_1'
                THEN to_timestamp('2024-12-31', 'YYYY-MM-DD')
            WHEN
                (data::jsonb -> 'form' -> 'school_information' ->> 'term')
                = 'term_2'
                THEN to_timestamp('2024-04-20', 'YYYY-MM-DD')
            WHEN
                (data::jsonb -> 'form' -> 'school_information' ->> 'term')
                = 'term3'
                THEN to_timestamp('2024-08-31', 'YYYY-MM-DD')
