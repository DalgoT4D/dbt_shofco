...
WITH combined_case_data AS (
    SELECT
        ...
        -> 'form'
        -> 'school_information'
        ->> 'wash_program' AS wash_program,
        data::jsonb
        -> 'form'
        -> 'school_information'
        ->> 'gender_program' AS gender_program,
        data::jsonb
        -> 'form'
        -> 'school_information'
        ->> 'gender_intervention' AS gender_intervention,
        data::jsonb
        -> 'form'
        -> 'school_information'
        ->> 'education_intervention' AS education_intervention,
        data::jsonb
        -> 'form'
        -> 'school_information'
        ->> 'which_wash_interventions_are_in_the_school' AS wash_intervention,
        data::jsonb
        -> 'form'
        -> 'school_information'
        ...
        -> 'form'
        -> 'school_information'
        ->> 'does_the_school_have_shofco_education_program' AS shofco_education_program,
        ...
        -> 'form'
        -> 'geographical_location'
        ->> 'name_of_the_interviewer' AS interviewer_name,
        data::jsonb
        -> 'form'
        ->> 'gps_location_of_the_facility' AS gps_location,
        data::jsonb
        -> 'form'
        ->> 'officegender_desk_locationname' AS office_gender_desk_location,
