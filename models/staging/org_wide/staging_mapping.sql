...
WITH combined_case_data AS (
    SELECT
        ...
        data::jsonb->'form'->'school_information'->>'gender_intervention' AS gender_intervention,
        data::jsonb->'form'->'school_information'->>'education_intervention' AS education_intervention,
        data::jsonb->'form'->'school_information'->>'which_wash_interventions_are_in_the_school' AS wash_intervention,
